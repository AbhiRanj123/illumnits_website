        ...
        <div className={styles.divfirst}>
          <div className={styles.div1}>
            <div className={styles.logo}>
              <Icon icon="mdi:location" color="#785140" width="2.5rem" />
            </div>
          ...
          <div className={styles.div2}>
            <div className={styles.logo}>
              <Icon icon="tabler:mail-filled" color="#785140" width="2.5rem" />
            </div>
            <div className={styles.address}>
          ...
          <div className={styles.div3}>
            <div className={styles.logo}>
              <Icon icon="carbon:phone-filled" color="#785140" width="2.5rem" />
            </div>
            <div className={styles.address}>
              <p>9845275678</p>
            </div>
